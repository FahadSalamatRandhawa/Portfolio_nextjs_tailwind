                ...
                <div className=" flex flex-wrap justify-center md:justify-start lg:justify-start gap-5">
                    <div className=" block w-60 h-40">
                        ...
                        <div className=" flex flex-col px-2 h-32 min-w-24 rounded-sm shadow-md shadow-indigo-500">
                            <div>Name</div>
                            <em>Provider</em>
                            <button className=" flex justify-center items-center hover:bg-indigo-600/40 hover:duration-1000 rounded-sm mt-10 outline-1 outline-indigo-400 outline gap-2">Validate Certification <GoVerified/></button>
                        </div>
                    </div>
                </div>
            </div>
